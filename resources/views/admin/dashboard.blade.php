    ...
    <div class="row g-3 mb-4 justify-content-center">
        ...
        <div class="col-sm-6 col-xl-3">
            <div class="stat-card h-100">
                ...
                <div class="stat-card-body">
                    <div class="stat-card-data">{{ $stats['products'] }}</div>
                </div>
                <div class="stat-card-footer">{{ $stats['products_active'] }} activos</div>
            </div>
        </div>
        ...
        <div class="col-sm-6 col-xl-2">
            <div class="stat-card h-100">
                ...
                <div class="stat-card-body">
                    <div class="stat-card-data">{{ $stats['categories'] }}</div>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-6 col-xl-3">
            <div class="stat-card h-100">
                ...
                <div class="stat-card-body">
                    <div class="stat-card-data">{{ $stats['users'] }}</div>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-6 col-xl-4">
            <div class="stat-card h-100">
                ...
                <div class="stat-card-body">
                    <div class="stat-card-data">{{ $stats['orders'] }}</div>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-6 col-xl-2">
            <div class="stat-card h-100">
                ...
                <div class="stat-card-body">
                    <div class="stat-card-data">{{ $stats['pending_orders'] }}</div>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-6 col-xl-5">
            <div class="stat-card h-100">
                ...
                <div class="stat-card-body">
                    <div class="stat-card-data">USD${{ number_format($stats['orders_revenue'], 2) }}</div>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-6 col-xl-5">
            <div class="stat-card h-100">
                ...
                <div class="stat-card-body">
                    <div class="stat-card-data">USD${{ number_format($stats['products_value'], 2) }}</div>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <tbody>
                            @forelse ($recentOrders as $order)
                                <tr>
                                    ...
                                    <td class="status-badge status-{{ strtolower($order->status) }}">{{ $order->status }}</td>
                                </tr>
                            @empty
                                <tr>
                        ...
                        <tbody>
                            @forelse ($lowStock as $product)
                                <tr>
                                    ...
                                    <td>
                                        <span class="stock-badge {{ $product->stock === 0 ? 'bg-danger' : 'bg-warning text-dark' }}">
                                            {{ $product->stock }}
                                        </span>
                                    </td>
                                </tr>
