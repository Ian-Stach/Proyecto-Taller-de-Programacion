{{--
    ...
    Variables inyectadas por CartController@index:
      $cartItems  → array de arrays con claves 'product', 'quantity' y 'subtotal'.
    ...
    Estructura:
      · Si hay ítems → tabla con productos, cantidades y subtotales
                     + resumen de pedido (subtotal, impuesto, total)
                     + botón de checkout y enlace para seguir comprando.
