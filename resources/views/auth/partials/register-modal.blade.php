{{--
    ...
    Error bag:    'register' → los errores de validación se agrupan bajo este nombre para no mezclarse con los de login ni forgotPassword.

    Campos:
      name                  → nombre del usuario.
      email                 → correo electrónico, debe ser único en la tabla users.
      password              → contraseña nueva, mínimo 8 caracteres.
      password_confirmation → debe coincidir exactamente con password. Laravel valida esto con la regla 'confirmed'.

    Nota sobre los IDs de los inputs:
      Se usan IDs con prefijo 'register-' (ej. register-email) para evitar colisiones con los inputs del modal de login que comparten el mismo DOM.
...
<div class="modal fade auth-modal" id="registerModal" tabindex="-1" aria-labelledby="registerModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <!-- El formulario envuelve body y footer del modal. @csrf → token de Laravel obligatorio para cualquier formulario POST. -->
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input id="register-name" type="text" name="name" value="{{ old('name') }}" class="form-control @error('name', 'register') is-invalid @enderror" required autocomplete="name">
                        @error('name', 'register')
                    ...
                    <div class="mb-3">
                        ...
                        <input id="register-email" type="email" name="email" value="{{ old('email') }}" class="form-control @error('email', 'register') is-invalid @enderror" required autocomplete="email">
                    ...
                    <div class="mb-3">
                        ...
                        <input id="register-password" type="password" name="password" class="form-control @error('password', 'register') is-invalid @enderror" required autocomplete="new-password">
                    ...
                    <div class="mb-3">
                        ...
                        <input id="register-password-confirmation" type="password" name="password_confirmation" class="form-control @error('password_confirmation', 'register') is-invalid @enderror" required autocomplete="new-password">
                        {{-- Los errores de confirmación de contraseña los adjunta Laravel al campo 'password', no a 'password_confirmation'. --}}
                    </div>
                </div>
