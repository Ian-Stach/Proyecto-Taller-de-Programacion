{{--
    ...
    Error bag:    'login'  → los errores de validación se agrupan bajo este nombre
                             para no mezclarse con los de register ni forgotPassword.
                             Ver app/Http/Requests/Auth/LoginRequest.php.

    Sesión:
      session('loginStatus') → mensaje de éxito que llega tras un reset de contraseña
                               exitoso. Lo flash NewPasswordController con la clave
                               'loginStatus' (no 'status') para evitar que el modal
...
>
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            {{--
                El formulario envuelve tanto el body como el footer del modal
                para que el botón "Entrar" del footer pueda hacer submit.
                action="route('login')" → POST a /login → AuthenticatedSessionController@store.
            ...
            >
                ...
                <div class="modal-body">
                    ...
                    {{--
                        ...
                        NewPasswordController flashea 'loginStatus' al redirigir a /login,
                        y aquí lo mostramos como alerta verde antes del formulario.
                        Se usa 'loginStatus' en lugar de 'status' para que el modal de
                        recuperación no lo consuma accidentalmente.
                    --}}
                    ...
                    <div class="mb-3">
                        ...
                        >Email</label>
                        {{--
                            old('email') repopula el campo si el formulario falla,
                            para que el usuario no tenga que volver a escribirlo.
                            @error('email', 'login') agrega la clase is-invalid de Bootstrap
                            que muestra el borde rojo y habilita .invalid-feedback.
                        --}}
                        <input id="email"
                               type="email"
                               name="email"
                    ...
                    <div class="mb-3">
                        ...
                        >Contraseña</label>
                        {{--
                            No usa old() porque las contraseñas nunca se repopulan
                            por seguridad (nunca deben volver al HTML como valor).
                        --}}
                        <input id="password"
                               type="password"
                               name="password"
                    ...
                    {{--
                        ...
                        Solo se muestra si la ruta 'password.request' existe en el sistema
                        (Route::has verifica esto en tiempo de render).
