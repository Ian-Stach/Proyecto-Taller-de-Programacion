                ...
                <div class="col-md-4 mb-4">
                    <div class="card h-100 shadow-sm border-warning">
                        <div class="card-header bg-warning text-dark">
                            <strong><?php echo e($favorite->product->deepestCategories()->pluck('name')->implode(', ') ?: 'Sin categorias'); ?></strong>
                        </div>
                        <div class="card-body">
                            <div class="text-center mb-3">
                                <span class="favorite-emoji"><?php echo e($favorite->product->dinosaur_emoji ?? '🦕'); ?></span>
                            </div>
