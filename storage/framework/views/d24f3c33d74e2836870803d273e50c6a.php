    ...
    <div class="container-fluid d-flex align-items-center gap-3">
        ...
        <div class="d-flex gap-3 flex-shrink-0">
            <?php if(Auth::check() && Auth::user()->is_admin): ?>
                <a class="d-inline-flex align-items-center gap-1 text-decoration-none header-brand" href="<?php echo e(route('admin.dashboard')); ?>">
            ...
            <?php else: ?>
                ...
                <img src="<?php echo e(asset('images/js_logo_header.png')); ?>" alt="logo" width="75" height="52" class="d-inline-block align-middle">

                <!-- Nombre de la tienda como enlace a /principal -->
                <a class="text-decoration-none header-brand" href="<?php echo e(route('principal')); ?>">Jurassic Store</a>
            <?php endif; ?>
        </div>
        ...
        <!-- ZONA CENTRAL: buscador con sugerencias en tiempo real
            ...
            value="<?php echo e(request('search')); ?>" → si el usuario ya buscó algo, el campo queda pre-relleno con el término actual. -->
        <form method="GET" action="<?php echo e(route('products.index')); ?>" class="header-search-form" data-header-search-form data-suggestions-url="<?php echo e(route('products.suggestions')); ?>" role="search"      >
            <div class="input-group header-search-group">
                <input class="form-control header-search-input" type="search" name="search" placeholder="Buscar productos..." value="<?php echo e(request('search')); ?>" aria-label="Buscar productos" autocomplete="off">
            ...
            <?php if(auth()->guard()->check()): ?>
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link text-decoration-none dropdown-toggle user-summary-link" href="#" id="userDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <span class="p-0 user-summary">
                            <?php if(Auth::user()->photo): ?>
                                <img src="<?php echo e(asset('storage/' . Auth::user()->photo)); ?>" class="user-summary-photo" alt="Foto de perfil">
                            <?php else: ?>
                                <div class="user-summary-avatar"><?php echo e(strtoupper(substr(Auth::user()->name, 0, 1))); ?></div>
                            <?php endif; ?>
                        </span>
                    </a>
                    ...
                    <ul class="dropdown-menu dropdown-menu-end summary-dropdown-menu" aria-labelledby="userDropdown">
                        ...
                        <li>
                            <a class="d-flex align-items-center gap-1 dropdown-item" href="<?php echo e(route('user')); ?>">
                        ...
                        <li>
                            <a class="d-flex align-items-center gap-1 dropdown-item" href="<?php echo e(route('orders.index')); ?>">
                                <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e3e3e3">
                        ...
                        <li>
                            <a class="d-flex align-items-center gap-1 dropdown-item" href="<?php echo e(route('favorites.index')); ?>">
